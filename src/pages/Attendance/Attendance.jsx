...
const Attendance = () => {
    ...
    const loadStudentsForClass =
        async (classId, dateOverride = selectedDate) => {
    ...
    const loadExistingAttendance =
        async (
            ...
            try {
                ...
                const response =
                    await api.get(
                        `/attendance?classId=${classId}&date=${encodeURIComponent(
                            englishDate
                        )}`
                    );
    ...
    const handleSubmit =
        async (event) => {
            ...
            try {
                ...
                const englishDate =
                    toEnglishDate(selectedDate);

                if (!englishDate) {

                    setError(
                        "Invalid BS date. Please select a valid date."
                    );
